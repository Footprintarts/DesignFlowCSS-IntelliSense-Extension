...
function activate(context) {
    ...
    // Completion Provider
    const completionProvider = vscode.languages.registerCompletionItemProvider({ language: "html", scheme: "file" }, {
                ...
                return Object.keys(utilities).map((key) => {
                    ...
                    if (utilities[key].styles) {
                        const styles = Object.entries(utilities[key].styles)
                            ...
                            .join("; ");
                        item.documentation = new vscode.MarkdownString(`**Description:** ${utilities[key].description}\n\n**Styles:**\n\`\`\`\n${styles}\n\`\`\``);
                    }
                    return item;
                });
            }
    ...
    const hoverProvider = vscode.languages.registerHoverProvider({ language: "html", scheme: "file" }, {
            ...
            if (range) {
                ...
                if (classNameMatches) {
                    ...
                    const classNameAtPosition = classNames.find((className) => {
                        ...
                        return (position.character >= range.start.character + classStart &&
    ...
    function pxToRemConverter(baseFontSize, pxValue) {
        return pxValue / baseFontSize;
    }
    context.subscriptions.push(completionProvider, hoverProvider);
    console.log('Congratulations, your extension "designflowcss-intellisense" is now active!');
    const disposable = vscode.commands.registerCommand("designflowcss-intellisense.helloWorld", () => {
        vscode.window.showInformationMessage("Hello World from DesignFlowCss IntelliSense!");
    });
